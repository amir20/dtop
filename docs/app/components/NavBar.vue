  ...
  >
    <div class="mx-auto flex h-16 max-w-300 items-center justify-between px-6">
      <div class="font-mono text-xl font-bold tracking-tight text-(--c-text)">
        <span class="text-(--c-accent)">$</span> dtop<span class="animate-blink text-(--c-accent)">_</span>
      </div>
      <div class="flex items-center gap-6">
        ...
        >
          <svg v-if="isDark" class="size-4.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
          ...
          <svg v-else class="size-4.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
              stroke-linecap="round"
              stroke-linejoin="round"
              stroke-width="2"
